	...
	setup: function() {
		if (
			...
			this.module !== config.previousModule ||
				...
				// Without this, Players can get testStart before moduleStart  which is a problem.
...
// Don't load the HTML Player on non-Browser environments
if ( typeof window === "undefined" ) {
	return;
}
...
// HTML Player initialization and load
QUnit.begin(function() {
	var qunit = id( "qunit" );
